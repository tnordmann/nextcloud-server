...
$application->registerRoutes($this, [
	'routes' => [
		...
		['name' => 'Svg#getSvgFromApp', 'url' => '/core/svg/{app}/{fileName}', 'verb' => 'GET'],
		['name' => 'Css#getCss', 'url' => '/core/css/{appName}/{fileName}', 'verb' => 'GET'],
		['name' => 'Js#getJs', 'url' => '/core/js/{appName}/{fileName}', 'verb' => 'GET'],
